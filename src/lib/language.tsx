...
const SPANISH_WORD_REPLACEMENTS: Array<[RegExp, string]> = [
  ...
  [/\bcomprension\b/gi, "comprensión"],
  [/\bconversacion\b/gi, "conversación"],
  [/\bduracion\b/gi, "duración"],
  [/\bestandar\b/gi, "estándar"],
  [/\bexposicion\b/gi, "exposición"],
  [/\bgarantia\b/gi, "garantía"],
  [/\bgarantias\b/gi, "garantías"],
  [/\bmaximo\b/gi, "máximo"],
  [/\bnegacion\b/gi, "negación"],
  [/\bopcion\b/gi, "opción"],
  [/\bpronunciacion\b/gi, "pronunciación"],
  [/\brapido\b/gi, "rápido"],
  [/\breduccion\b/gi, "reducción"],
  [/\bsegun\b/gi, "según"],
  [/\bsolida\b/gi, "sólida"],
  [/\btraduccion\b/gi, "traducción"],
  [/\bunico\b/gi, "único"],
  [/\bvacilacion\b/gi, "vacilación"],
  [/\bespana\b/gi, "España"],
  [/\bcapitulos\b/gi, "capítulos"],
  [/\bdandote\b/gi, "dándote"],
];
